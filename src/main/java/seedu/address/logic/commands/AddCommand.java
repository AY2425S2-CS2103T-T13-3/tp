...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a candidate to RecruitIntel. "
            + "Parameters: "
            + PREFIX_NAME + "NAME "
            + PREFIX_PHONE + "PHONE "
            + PREFIX_EMAIL + "EMAIL "
            ...
            + PREFIX_JOB_POSITION + "Software Engineer "
            + PREFIX_TEAM + "iOS Development "
