...
public class CommandTestUtil {
    ...
    public static final String VALID_JOB_POSITION_AMY = "Software Engineer";
    public static final String VALID_JOB_POSITION_BOB = "Product Manager";
    public static final String VALID_TEAM_AMY = "Engineering";
    public static final String VALID_TEAM_BOB = "Product";
    ...
    public static final String INVALID_JOB_POSITION_DESC = " " + PREFIX_JOB_POSITION + INVALID_JOB_POSITION;
    public static final String INVALID_TEAM_DESC = " " + PREFIX_TEAM + INVALID_TEAM;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withJobPosition(VALID_JOB_POSITION_AMY).withTeam(VALID_TEAM_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withJobPosition(VALID_JOB_POSITION_BOB).withTeam(VALID_TEAM_BOB)
     ...
     * - the RecruitIntel, filtered person list and selected person in {@code actualModel} remain unchanged
     */
