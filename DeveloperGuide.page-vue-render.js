...
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("1")]),_v(" looking for course mate to discuss schoolwork with")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("2")]),_v(" looking for a way to store their course mate contacts")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("3")]),_v(" has a need to manage a significant number of contacts")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("4")]),_v(" prefer desktop apps over other types")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("5")]),_v(" can type fast")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("6")]),_v(" prefers typing than mouse interactions")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Provide quick access to students who are taking similar modules")]),_v(" "),_c('li',[_v("Provide a friendly command line format for users who prefer CLI application")]),_v(" "),_c('li',[_v("Organise students’ contacts in a relevant & friendly format")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Find relevant course mate's email")]),_v(" "),_c('td',[_v("I can contact them for study sessions")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Find relevant course mate's phone numbers")]),_v(" "),_c('td',[_v("I can contact them for study sessions")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Find relevant course mate's module")]),_v(" "),_c('td',[_v("I can know which friends take the same module")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Add course mate")]),_v(" "),_c('td',[_v("I can add course mate's contact")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Delete course mates")]),_v(" "),_c('td',[_v("I can delete unwanted course mate")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("CLI lover")]),_v(" "),_c('td',[_v("Type command to organize contacts")]),_v(" "),_c('td',[_v("I can organize them in a friendly way")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("Add module tags to Course mates")]),_v(" "),_c('td',[_v("I can easily track which modules my friends are taking and contact the course mate's to discuss school work")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("Update course mate phone")]),_v(" "),_c('td',[_v("I can correct them if there is a typo")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("Update course mate address")]),_v(" "),_c('td',[_v("I can correct them if there is a typo")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("Update course mate name")]),_v(" "),_c('td',[_v("I can correct them if there is a typo")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("Toggle the colour theme of the application")]),_v(" "),_c('td',[_v("So that my eyes are comfortable while using the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("Import contacts from a spreadsheet")]),_v(" "),_c('td',[_v("I can quickly add contacts I have collected")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUSMeet")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-uc01-add-coursemate"}},[_v("Use case: UC01 – Add Coursemate"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc01-add-coursemate","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor:")]),_v(" NUS Student")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User types the command to add a new coursemate along with details.")]),_v(" "),_c('li',[_v("NUSMeet validates the input and adds the coursemate.")]),_v(" "),_c('li',[_v("NUSMeet displays confirmation of successful addition."),_c('br'),_v(" "),_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" NUSMeet detects invalid or missing input.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("2a1.")]),_v(" NUSMeet displays an error message showing the correct command format.")]),_v(" "),_c('li',[_c('strong',[_v("2a2.")]),_v(" User re-enters the corrected command with proper details.\n"),_c('ul',[_c('li',[_v("Steps 2a1–2a2 repeat until input is valid.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes from step 2.")])])])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("*a.")]),_v(" At any time, User cancels the operation by discarding typed input.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-uc02-tag-coursemates-with-modules"}},[_v("Use case: UC02 – Tag Coursemates with Modules"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc02-tag-coursemates-with-modules","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor:")]),_v(" NUS Student")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User types the command to tag existing coursemates with module codes and IDs.")]),_v(" "),_c('li',[_v("NUSMeet validates the input and applies the tags.")]),_v(" "),_c('li',[_v("NUSMeet displays confirmation of successful tagging."),_c('br'),_v(" "),_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" NUSMeet detects invalid or duplicate module codes or IDs.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("2a1.")]),_v(" NUSMeet displays an error message with the correct command format.")]),_v(" "),_c('li',[_c('strong',[_v("2a2.")]),_v(" User re-enters corrected command with proper module codes and IDs.\n"),_c('ul',[_c('li',[_v("Steps 2a1–2a2 repeat until input is valid.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes from step 2.")])])])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("*a.")]),_v(" At any time, User cancels the operation by discarding typed input.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-uc03-find-coursemates-by-module"}},[_v("Use case: UC03 – Find Coursemates by Module"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc03-find-coursemates-by-module","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Actor:")]),_v(" NUS Student")])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User types the command to find coursemates by module code(s).")]),_v(" "),_c('li',[_v("NUSMeet validates the input and displays a list of matching coursemates."),_c('br'),_v(" "),_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("2a.")]),_v(" NUSMeet detects invalid or incorrectly formatted module codes.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("2a1.")]),_v(" NUSMeet displays an error message indicating the correct format for the find command.")]),_v(" "),_c('li',[_c('strong',[_v("2a2.")]),_v(" User re-enters the command with the corrected format.\n"),_c('ul',[_c('li',[_v("Steps 2a1–2a2 repeat until input is valid.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes from step 2.")])])])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("*a.")]),_v(" At any time, User cancels the operation by discarding typed input.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 24 Mar 2025, 11:56:03 GMT+8]")])])])}
}];
